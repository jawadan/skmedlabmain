      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              ...
              <Link to="/" className="inline-block" aria-label="Cruip">
                <svg width="45" height="45" viewBox="0 0 257 258" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-sm text-gray-600">
              <ul className="text-sm">
                <li className="mb-2">
                  <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Конфидециальность</Link>{/* · <Link to="#" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Terms</Link>*/}
                </li>
                <li className="mb-2">
              ...
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    <input id="newsletter" type="email" className="form-input w-full text-gray-800 px-3 py-2 pr-12 text-sm" placeholder="Ваш email" required />
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe">
                      <span className="absolute inset-0 right-auto w-px -ml-px my-2 bg-gray-300" aria-hidden="true"></span>
                      <svg className="w-3 h-3 fill-current text-gray-800 hover:bg-yellow-600 mx-3 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a href="https://twitter.com/joerogan" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <a href="https://google.com/" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Instagram">
                <svg className="w-8 h-8 fill-current" viewBox="-256 0 1024 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="ml-4">
              <a href="https://www.facebook.com/donquikhan" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
