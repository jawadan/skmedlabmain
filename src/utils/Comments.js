                ...
                <div class="-mx-3 md:flex items-start">
                    ...
                    <div class="px-3 md:w-1/3">
                        ...
                        <div class="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                            <div class="w-full flex mb-4 items-center">
                                <div class="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                                    <img src="https://i.imgur.com/MWoDkfv.png" alt="Батырбаева Динара Жармухановна" />
                                </div>
                                <div class="flex-grow pl-3">
                                    <h6 class="font-bold text-sm text-gray-900">Батырбаева Динара Жармухановна</h6>
                                    <p className="text-sm text-gray-600">КМН, зав.научной КДЛ КазНМУ </p>
                                    <p className="text-sm text-gray-600">им.С.Д.Асфендиярова</p>
                                </div>
                            </div>
                            <div class="w-full">
                                <p class="text-sm leading-tight text-justify"><ShowMoreText
                                    ...
                                    expanded={false}
                                    width={280}
                                >"Турсынова Сауле Кадырхановна – квалифицированный специалист в области лабораторной диагностики. Она посвятила всю свою трудовую деятельность лабораторной службе. Сауле Кадырхановна начинала работать в то время, когда лаборатории работали на ручных методах, работа была трудоемкой, сложной и длительной и все зависело от знаний и опыта лабораторного специалиста. Сауле Кадырхановна за эти годы прошла путь от рядового сотрудника до опытного менеджера. Знаю Сауле Кадырханову более 10 лет, когда она работала в клинико-диагностической лаборатории БСМП г.Алматы. Затем, став заведующей лабораторией в одной из ведущих клиник города, городской клинической больнице №5, она из маленькой лаборатории создала крупную клинико-диагностическую лабораторию, в которой централизованно проводили лабораторные исследования по Медеускому району г.Алматы. На сегодняшний день данная лаборатория является одной из крупных и перспективных аккредитованных лабораторий города. Сауле Кадырхановна несколько лет возглавляла лабораторную службу и являлась главным внештатным специалистом по лабораторной службе г.Алматы, одновременно - координатором и организатором общества врачей-лаборантов города. В настоящее время, когда проблема диагностики заболеваний актуально стоит в медицине и активно развивается в Казахстане, профессиональный и грамотный специалист, как Сауле Кадырхановна, является ценным кадром в области лабораторной медицины. Она - наставник, учитель и коллега, взрастившая целую плеяду молодого поколения. Сейчас ее ученики трудятся на разных должностях в различных лабораториях не только города, но и страны. Она беззаветно предана своей работе. В трудовых буднях Сауле Кадырхановны я неоднократно замечала любовь, терпение к своей работе, умение создать благоприятную и трудовую атмосферу в коллективе. Стремясь внести свой собственный вклад в это нелегкое время в лабораторную диагностику, Сауле Кадырхановна решила создать собственное дело, куда вложила душу, профессионализм и труд. Доверившись лаборатории Сауле Кадырхановны, пациенты получат квалифицированный и достоверный результат."
                                </ShowMoreText></p>
                            </div>
                        </div>
                    </div>
